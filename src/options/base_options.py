...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--which_model_netD', type=str, default='unet_256', help='selects model to use for netD')
        ...
        self.parser.add_argument('--model', type=str, default='single_unet',
        ...
        self.parser.add_argument('--display_host', type=str, default='http://bigiris.cs.stonybrook.edu')
        ...
        self.parser.add_argument('--randomSize', action='store_true', help='if specified, do not flip the images for data augmentation')
